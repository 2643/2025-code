...
public class RobotContainer {
  ...
  public static JoystickButton encoderGroundSwitch = new JoystickButton(driver, 6);
  public static JoystickButton feederGroundSwitch = new JoystickButton(driver, 11);
  public static JoystickButton buttonUp = new JoystickButton(driver, 8);
  public static JoystickButton buttonDown = new JoystickButton(driver, 9);
